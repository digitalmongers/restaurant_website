    ...
    <div className="bg-[#FCFCFC] w-full flex justify-center overflow-x-hidden font-sans">
      ...
      >
        ...
        <div className="absolute top-[160px] right-[40px] w-[860px] h-[860px]">
          ...
          {/* 1. Hot spicy Food bubble */}
          <Card className="absolute top-[100px] left-[-30px] z-20 outline-none border-none bg-white p-0 overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.12)] rounded-[30px] rounded-br-[0px]">
          ...
          {/* 2. Spicy noodles card - Exact requested width/height: 349x132 */}
          <Card
            className="absolute bottom-[20px] right-[430px] z-20 bg-white outline-none border-none shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)]"
            ...
            <CardContent className="flex items-center gap-[20px] px-[20px] py-[20px] h-full p-0">
              <div className="w-[90px] h-[90px] relative rounded-[18px] overflow-hidden bg-[#FFEEEE] flex-shrink-0 flex items-center justify-center pt-2">
                <div className="w-[85%] h-[85%] relative">
                  <Image src="/noodles.png" alt="Spicy noodles" fill className="object-cover" />
                </div>
              </div>
          ...
          {/* 3. Vegetarian salad card - Exact requested width/height: 349x132 */}
          <Card
            className="absolute bottom-[20px] right-[60px] z-20 bg-white outline-none border-none shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)]"
            style={{ width: '349px', height: '132px', borderRadius: '24px' }}
          >
            <CardContent className="flex items-center gap-[20px] px-[20px] py-[20px] h-full p-0">
              <div className="w-[90px] h-[90px] relative rounded-[18px] overflow-hidden bg-[#EEFFED] flex-shrink-0 flex items-center justify-center pt-2">
                <div className="w-[85%] h-[85%] relative">
                  <Image src="/salad.png" alt="Vegetarian salad" fill className="object-cover" />
                </div>
              </div>
              <div className="flex flex-col gap-[4px] mt-1">
